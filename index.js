...
const routes = require("./public/routes");//mostrando onde nossas rotas estão
...
app.use(express.static(path.join(__dirname)));//dá o caminho da nossa pasta PUBLIC
...
const port = process.PORT || 3000;// informa que ele ou está rodando no localhost 3000 ou outra porta
